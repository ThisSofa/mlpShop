...
<body>
<h2> Раді бачити вас на сторінці нашого магазину</h2>
  <table>
    <tr>
      <th>№</th>
      <th>Назва</th>
...
echo "<td>" . $i['price'] ."</td>";
echo "<td>
<button class='button-64'name='button1'><a href = 'form.php?id=" . $i['id'] ."'><span class='text'>Купити<span></a></button></td>";
echo "</tr>";
}
?>
...
<button class="button-64" name="button2"><a href="./shop/index.html"><span class="text">Повернутися</span></a></button>

<button class="button-64" name="button1"><a href="login.html"><span class="text">Увійти, як адміністратор</span></a></button>
</body>
</html>